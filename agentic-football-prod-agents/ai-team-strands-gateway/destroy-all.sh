...
# ============================================================================
# Destroy all 5 AI Team (Gateway) agents from Bedrock AgentCore
# ============================================================================
#
# Usage:
#   ./destroy-all.sh              # destroy all 5 agents
#   ./destroy-all.sh ai-gk        # destroy one agent
#
# Note: This does NOT delete the Lambda functions, IAM roles, or MCP Gateway.
# To remove those, use the AWS console or run with --full flag.
# ============================================================================
...
echo "=========================================="
echo "  AI Team (Gateway) — Destroy Agents"
echo "=========================================="
echo ""
...
get_runtime_name() {
  case "$1" in
    ai-gk)   echo "ai_gk_gateway_agent" ;;
    ai-def)  echo "ai_def_gateway_agent" ;;
    ai-mid)  echo "ai_mid_gateway_agent" ;;
    ai-fwd1) echo "ai_fwd1_gateway_agent" ;;
    ai-fwd2) echo "ai_fwd2_gateway_agent" ;;
    *) echo "" ;;
  esac
}
