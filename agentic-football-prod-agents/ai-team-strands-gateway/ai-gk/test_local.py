"""Local test for the GK (Gateway) agent — tests state summary, parsing, and fallback.

Gateway MCP tools are NOT tested locally (require deployed Gateway).
"""
...
if __name__ == "__main__":
    ...
    print("Deploy to AgentCore with GATEWAY_URL to test with actual tools.")
